...
exports.fetchObjectsByFilter = function(filter, base) {
    return new Promise((resolve, reject) => {
...
exports.fetchUser = function(dn, parentGroups = true) {
    return exports.fetchObject(dn)
        .then((user) => {
            return exports.populateUserGroups(user, parentGroups);
        })
};
...
exports.populateUserGroups = function(user, parentGroups = true) {
...
exports.populateUserTitle = function(user) {
  return Promise.resolve()
    .then(() => {
      if (!!user.ou) {
        return exports.fetchObject(user.ou)
          .then(group => {
            user.title = group.o;
            return user;
          })
...
exports.fetchParentGroups = function (groupDn) {
  return exports.fetchObjectsByFilter('(member=' + groupDn + ')', 'ou=groups,' + config.server.base);
}
